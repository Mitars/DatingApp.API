...
namespace DatingApp.DataAccess
{
    ...
    {   
        ...
        /// The task result contains the user.
        /// </returns>
        Task<Result<Photo, Error>> GetCurrentUser(int id);
        ...
        /// </returns>
        Task<Result<PagedList<Photo>, Error>> GetUsers(UserParams userParams);

        /// <summary>
        /// Adds a new entity.
        /// </summary>
        /// <typeparam name="T">The entity which to create.</typeparam>
        Task<Result<Photo, Error>> Add(User entity);        
        ...
        /// </returns>
        Task<Result<Photo, Error>> Get(int userId, int recipientId);

        /// <summary>
        /// Adds a new entity.
        /// </summary>
        /// <typeparam name="T">The entity which to create.</typeparam>
        Task<Result<Photo, Error>> Add(Like entity);        
    }
}